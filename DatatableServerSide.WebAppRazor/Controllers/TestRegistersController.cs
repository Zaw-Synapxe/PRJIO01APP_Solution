...
using DatatableServerSide.WebAppRazor.Extensions;
...
namespace DatatableServerSide.WebAppRazor.Controllers
{
    ...
    [ApiController]
    public class TestRegistersController : ControllerBase
    {
        ...
        /////////// </returns>
        ////////[HttpGet("SeedData")]
        ////////public async Task<IActionResult> SeedData(int number)
        ////////{
        ////////    await SeedDatatoDb();
        ////////    return Ok(number);
        ////////}
        ...
        public async Task<IActionResult> LoadTable([FromBody] DtParameters dtParameters)
        {
            ...
            var result = _context.tbl_TestRegisters.AsQueryable();
            ...
            var totalResultsCount = await _context.tbl_TestRegisters.CountAsync();
            ...
            return Ok(new DtResult<TestRegister>
            {
        ...
        {
            if (!_context.tbl_TestRegisters.Any())
            {
                for (var i = 0; i < 1000; i++)
                {
                    await _context.tbl_TestRegisters.AddAsync(new TestRegister
                    {
